...
public class TennisGame3 implements TennisGame {
    ...
    public String getScore() {
        if (bothPlayerAreUnderForty()) {
            ...
            playerWithHighestScore = player1.getPoints() > player2points ? player1.getName() : player2name;
    ...
    private boolean scoreDifferenceIsOne() {
        return Math.abs(player1.getPoints() - player2points) == 1;
    }
    ...
    private boolean bothPlayerAreUnderForty() {
        return player1.getPoints() < FORTY && player2points < FORTY;
    }
